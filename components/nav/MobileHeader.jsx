...
export default function MobileHeader({ items, nombre }) {
  ...
  return (
    <>
      <div className="md:hidden flex items-center justify-between bg-slate-900 text-white px-4 py-3 print:hidden sticky top-0 z-30 shadow">
      ...
      {abierto && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-64 max-w-[85vw] bg-slate-900 text-slate-300 flex flex-col">
