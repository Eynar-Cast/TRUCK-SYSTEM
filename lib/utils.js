...
/**
 * Formatea una fecha en formato AAAA-MM-DD como dd/mm/aaaa SIN conversiones
 * de zona horaria (evita que el día se desplace al mostrarla).
 * @returns {string} Ej: "05/08/2026" o "—" si no hay fecha
 */
export function fmtFechaISO(iso) {
...
/**
 * Descarga un archivo del mismo origen (mantiene la cookie de sesión).
 * @param {string} url – endpoint que responde con Content-Disposition attachment
 */
